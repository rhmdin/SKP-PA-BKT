...
(function (l) {
    ...
    function Ja(a) {
        ...
        if (a.scrollBarVis !== X && a.scrollBarVis !== q)
            ...
            G &&
                da(function (D, W) {
                    D.innerHTML =
                        '<div class="dataTables_sizing">' + fa[W] + "</div>";
                    D.childNodes[0].style.height = "0";
                    D.childNodes[0].style.overflow = "hidden";
                    D.style.width = I[W];
                }, Ca);
            ...
            if (-1 !== l.inArray(!1, f)) a._bLoadingState = !1;
                ...
                if (b.columns) {
                    ...
                    for (d = b.columns.length; f < d; f++) {
                        ...
                        g.search !== q &&
                            l.extend(a.aoPreSearchCols[f], $b(g.search));
                    }
                    h && h.columns.adjust();
                }
                a._bLoadingState = !1;
    ...
    function Za(a, b, c) {
        if (y.moment) {
            ...
            d = b
                ? y.luxon.DateTime.fromFormat(a, b)
                : y.luxon.DateTime.fromISO(a);
            if (!d.isValid) return null;
            d.setLocale(c);
        } else
            b
    ...
    z("destroy()", function (a) {
        ...
        return this.iterator("table", function (b) {
            ...
            f &&
                d != f.parentNode &&
                (g.children("tfoot").detach(), g.append(f));
            b.aaSorting = [];
            b.aaSortingFixed = [];
            Va(b);
    ...
    if (Intl)
        try {
            for (
                var Ha = new Intl.NumberFormat().formatToParts(100000.1),
                    ra = 0;
                ra < Ha.length;
                ra++
            )
